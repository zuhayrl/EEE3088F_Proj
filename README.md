...
* [Code]([code/code.md](https://github.com/zuhayrl/EEE3088F_Proj/blob/Code/code.md)) - In this branch, majority of the code to be uploaded on the microcontroller will be posted.
